...
For `0.1.x`, the intent is to keep the MSRV stable unless there is a clear
release-quality reason to move it.

## Semver Rules for `0.1.x`
...
For the published `0.1.x` line, treat these as breaking even before `1.0`:
